    ...
    <section className="section tc-light">
        ...
        <div className="container">
            <div className="section-head text-center wide-auto-sm wide-auto">
                <h2 className="title">How Hexa Used?</h2>
            ...
            <div className="nk-block nk-block-features-s3">
                <div className="row justify-content-center gutter-vr-30px">
                    <div className="col-lg-6 col-md-10">
                        <div className="feature feature-s3 feature-center card-custom">
                    ...
                    <div className="col-lg-6 col-md-10">
                        <div className="feature feature-s3 feature-center card-custom">
                            ...
                            <div className="feature-text">
                                <h4 className="title title-md title-dark">Market Analysis</h4>
                    ...
                    <div className="col-lg-6 col-md-10">
                        <div className="feature feature-s3 feature-center card-custom">
                            ...
                            <div className="feature-text">
                                <h4 className="title title-md title-dark">Lorem ipsum dolor sit amet,</h4>
